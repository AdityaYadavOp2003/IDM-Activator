...
::
::   Homepages: Hackgod Adi
::
::       Telegram: @hackgodadi01
::
::============================================================================
...
cls
color 07
title  Hackgod Adi IDM Script %iasver%
...
echo:
echo:
call :_color2 %_White% "             " %_Green% "Create By Aditya"
echo:            ___________________________________________________ 
echo:
echo:               Developed By - Hackgod Adi
echo:               Github: Will Add Link Soon
echo:            ___________________________________________________ 
echo:                                                               
echo:               [1] Activate
echo:               [2] Freeze Trial
...
if %_erl%==6 exit /b
if %_erl%==5 echo "Will Update Soon" & goto MainMenu
